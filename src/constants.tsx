...
export const PROJECTS = [
    {title: "model inspector",
        ...
        description: "React-TypeScript app built with React Three Fiber and Drei for interactive 3D model visualization, featuring drag-and-drop file upload and DRACO decompression, automatic camera positioning, environment controls, and a custom minimal UI",
        descriptionEs: "Aplicación React-TypeScript construida con React Three Fiber y Drei para visualización interactiva de modelos 3D, con carga de archivos por drag-and-drop y descompresión DRACO, automatización de cámara, controles de entorno y una UI minimalista personalizada",
